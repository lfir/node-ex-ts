const email = 'mailto:psljp@protonmail.com',
  ...
  img0 =
    "<img src='" +
    baseImgUrl +
    "logo-github.png' alt='GitHub Logo' title='GitHub Profile' style='width:60px;height:60px;margin-right:20px;'>",
  a0 =
    "<a href='https://github.com/Asta1986' target='_blank' rel='noreferrer noopener'>" +
    img0 +
    '</a>',
  img1 =
    "<img src='" +
    baseImgUrl +
    "email-button.png' alt='Email Icon' title='Send Email' style='width:60px;height:60px;margin-left:20px;'>",
